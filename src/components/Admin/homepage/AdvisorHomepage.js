...
import Status from "../leave/AdvisorStatus";
import "./Homepage.css";
...
const HomePage = () => {
  ...
  const username = JSON.parse(localStorage.getItem("advisor")).username;
  const email = JSON.parse(localStorage.getItem("advisor")).email;
  return (
    <>
